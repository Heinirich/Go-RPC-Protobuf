...
type Student struct {
	...
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`    // Unique identifier for student, uses 64-bit integer
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // Student's name as a string
	Age           int32                  `protobuf:"varint,3,opt,name=age,proto3" json:"age,omitempty"`  // Student's age as 32-bit integer
...
type SearchByID struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // The ID to search for
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SearchByName struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // The name to search for
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
